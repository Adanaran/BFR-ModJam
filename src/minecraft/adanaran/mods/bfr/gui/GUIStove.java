...
public class GUIStove extends GuiContainer {
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		String s = this.stoveInventory.isInvNameLocalized() ? this.stoveInventory
				.getInvName() : I18n.func_135053_a(this.stoveInventory
				.getInvName());
	...
	protected void drawGuiContainerBackgroundLayer(float f, int i, int j) {
		...
		if (stoveInventory.isBurning()) {
			...
			this.drawTexturedModalRect(k + 9, l + 48 - i1, 176, 12 - i1, 14,
					i1 + 2);
		}
